import { TColor } from '@/libs/models/root.model';
...
function ButtonIcon({
  ...
  return (
    <button
      ...
      type={type}
      className={clsx(
        'inline-flex items-center p-1 text-center text-sm font-medium focus:outline-none focus:ring-2',
        ...
        color === 'warning' &&
          'bg-warning-main text-white hover:bg-warning-hover focus:ring-warning-ring ',
        color === 'secondary' &&
          'bg-secondary-main text-white hover:bg-secondary-hover focus:ring-secondary-ring ',
        color === 'info' &&
